    ...
    <div class="row mb-2">
      <div class="col-sm-6">
        <div class="d-flex justify-content-between align-items-center">
          <h1 class="m-0 text-dark" style="margin-right: 20px;">Manage Accounts</h1>
          <a href="user_account.php?user=<?php echo $_REQUEST['user']?>&action=add-new" class="btn btn-primary btn-sm">Add New</a>
        </div>
      </div>
      <!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="#" style="color: white;">Accounts</a></li>
...
<section class="content">
  ...
  <?php if(isset($_GET['action'])) { ?>
      ...
      <table class="table table-bordered" style="background-color: #22668D;">
        <thead>
          <tr>
            <th>SNo</th>
            <th>Name</th>
